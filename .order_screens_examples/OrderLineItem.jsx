		...
		>
			<div className="flex items-start gap-4">
				...
				<div className="flex-1 grid grid-cols-12 gap-3">
					...
					<div className="col-span-5 item-search-container relative">
					...
					<div className="col-span-2">
						...
						<input
							...
							placeholder="0"
							className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm text-center"
						/>
					</div>
					...
					<div className="col-span-2">
						...
						<div className="relative">
							...
							<input
								...
								placeholder="0.00"
								className="w-full pl-7 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm text-right"
							/>
						</div>
					</div>
					...
					<div className="col-span-1">
						...
						<div className="w-full px-3 py-2 border border-gray-100 rounded-lg bg-gray-50 text-sm text-right font-medium text-gray-700">
							${extCost.toFixed(2)}
						</div>
					</div>
				</div>
